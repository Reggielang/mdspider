...
class MdspiderSpiderMiddleware:
...
class MdspiderDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class CookieMiddleware:
    ...
    def update_cookies(self):
        try:
            response = requests.get('http://www.qi-wmcard.com', headers={'User-Agent': random.choice(self.user_agents)})
